-- Eval fixture data for the Development Control Center.
-- Reproduces design-handoff §9's mock dataset (4 projects, 14 tickets, 13
-- skills, 7 PRs, 8 runs, 8 jobs, 4 forms) INCLUDING the four intentional
-- unhappy paths: customer-portal is a dirty repository, DCC-144 has a failed
-- validation, delivery ND-8841 failed with a 504, and RUN-0898 timed out.
--
-- CONTRACT this file assumes about the migrations in packages/database
-- (state this explicitly in your migration DDL — see goal.md "Harness
-- conventions"):
...
-- harness/run-evals.sh, which truncates before each load).
...
-- by run-evals.sh invoking the real `scripts/create-admin.ts` (PRD §10)
-- non-interactively with DCC_EVAL_ADMIN_USER / DCC_EVAL_ADMIN_PASSWORD (see
-- harness/HARNESS_CONVENTIONS.md) BEFORE this file is loaded — that exercises
-- the real Argon2id path end-to-end and is what SEC-10 actually asserts.
...
('00000000-0000-0000-0000-000000000001','va-jobs-platform','VA Jobs Platform','Main Virtual Assistant jobs platform',true,'__REPO_PATH_VA_JOBS_PLATFORM__','internet-nederland','va-jobs-platform','main',
...
('00000000-0000-0000-0000-000000000002','corporate-site','Corporate Site','Public marketing website and vacancy pages',true,'__REPO_PATH_CORPORATE_SITE__','internet-nederland','corporate-site','main',
...
('00000000-0000-0000-0000-000000000003','customer-portal','Customer Portal','Authenticated client dashboard and billing views',true,'__REPO_PATH_CUSTOMER_PORTAL__','internet-nederland','customer-portal','main',
...
('00000000-0000-0000-0000-000000000004','billing-api','Billing API','Invoicing, subscriptions and SEPA collection service',true,'__REPO_PATH_BILLING_API__','internet-nederland','billing-api','main',
...
('00000000-0000-0000-0000-000000000147','DCC-147','00000000-0000-0000-0005-000000000002','00000000-0000-0000-0000-000000000001','Add CSV export to the candidate list','Recruiters want a CSV export button.','Feature','medium','Triage','j.smit',NULL,NULL,NULL,'CSV downloads all visible candidates','No export option exists',NULL,'{}'::jsonb,'basic','sonnet','high',NULL,NULL,NULL,NULL,NULL,NULL,NULL, now() - interval '41 minutes', now() - interval '9 minutes'),
...
('00000000-0000-0000-0000-000000000136','DCC-136','00000000-0000-0000-0005-000000000001','00000000-0000-0000-0000-000000000002','Add structured data to vacancy detail pages','SEO improvement.','SEO','medium','Completed','m.bakker',NULL,NULL,NULL,'JobPosting structured data present','No structured data',NULL,'{}'::jsonb,'basic','sonnet','high',NULL,NULL,NULL,NULL,NULL,NULL,NULL, now() - interval '6 days', now() - interval '2 days'),
...
(gen_random_uuid(),'00000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000140',NULL,'github','internet-nederland/corporate-site',218,'http://127.0.0.1:8991/internet-nederland/corporate-site/pull/218','Raise secondary button contrast to WCAG AA','dcc-worker','open','review_required','success',true,'feedback/DCC-140-button-contrast','main','a1b2c3d',NULL, now() - interval '3 hours', now() - interval '2 hours', NULL, NULL, now(), now(), now()),
(gen_random_uuid(),'00000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000139',NULL,'github','internet-nederland/customer-portal',177,'http://127.0.0.1:8991/internet-nederland/customer-portal/pull/177','Extend session lifetime and add sliding refresh','dcc-worker','open','changes_requested','failure',false,'feedback/DCC-139-session-lifetime','main','b2c3d4e',NULL, now() - interval '6 hours', now() - interval '1 hour', NULL, NULL, now(), now(), now()),
(gen_random_uuid(),'00000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000138',NULL,'github','internet-nederland/va-jobs-platform',642,'http://127.0.0.1:8991/internet-nederland/va-jobs-platform/pull/642','Fix vacancy link generation in alert e-mails','dcc-worker','closed','approved','success',false,'feedback/DCC-138-alert-links','main','c3d4e5f','d4e5f6a', now() - interval '1 day', now() - interval '22 hours', now() - interval '22 hours', now() - interval '22 hours', now(), now(), now()),
(gen_random_uuid(),'00000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000136',NULL,'github','internet-nederland/corporate-site',211,'http://127.0.0.1:8991/internet-nederland/corporate-site/pull/211','Add JobPosting structured data to vacancy pages','dcc-worker','closed','approved','success',false,'feedback/DCC-136-structured-data','main','e5f6a7b','f6a7b8c', now() - interval '2 days', now() - interval '2 days', now() - interval '2 days', now() - interval '2 days', now(), now(), now()),
(gen_random_uuid(),'00000000-0000-0000-0000-000000000001',NULL,NULL,'github','internet-nederland/va-jobs-platform',640,'http://127.0.0.1:8991/internet-nederland/va-jobs-platform/pull/640','Bump pnpm lockfile and drop unused deps','j.smit','open','review_required','pending',false,'chore/deps-july','main','a7b8c9d',NULL, now() - interval '9 hours', now() - interval '4 hours', NULL, NULL, now(), now(), now()),
(gen_random_uuid(),'00000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000141',NULL,'github','internet-nederland/billing-api',96,'http://127.0.0.1:8991/internet-nederland/billing-api/pull/96','Introduce SEPA mandate table and provider port','dcc-worker','open','draft','pending',true,'feedback/DCC-141-sepa-mandate','main','b8c9d0e',NULL, now() - interval '1 hour', now() - interval '26 minutes', NULL, NULL, now(), now(), now()),
(gen_random_uuid(),'00000000-0000-0000-0000-000000000003',NULL,NULL,'github','internet-nederland/customer-portal',174,'http://127.0.0.1:8991/internet-nederland/customer-portal/pull/174','Revert billing widget experiment','m.bakker','closed',NULL,NULL,false,'revert/billing-widget','main','c9d0e1f',NULL, now() - interval '5 days', now() - interval '4 days', NULL, now() - interval '4 days', now(), now(), now())
...
('00000000-0000-0000-0006-000000008840','00000000-0000-0000-0006-000000000002','ticket.created','00000000-0000-0000-0000-000000000148','00000000-0000-0000-0000-000000000001',NULL,NULL,'idem-nd-8840','{"ticket":"DCC-148"}'::jsonb,'delivered',1,200,NULL, now() - interval '6 minutes', now() - interval '6 minutes', now()),
('00000000-0000-0000-0006-000000008839','00000000-0000-0000-0006-000000000002','execution.started','00000000-0000-0000-0000-000000000146','00000000-0000-0000-0000-000000000004',NULL,NULL,'idem-nd-8839','{"ticket":"DCC-146"}'::jsonb,'delivered',1,200,NULL, now() - interval '14 minutes', now() - interval '14 minutes', now()),
('00000000-0000-0000-0006-000000008838','00000000-0000-0000-0006-000000000002','validation.failed','00000000-0000-0000-0000-000000000144','00000000-0000-0000-0000-000000000003',NULL,NULL,'idem-nd-8838','{"ticket":"DCC-144"}'::jsonb,'delivered',2,200,NULL, now() - interval '34 minutes', now() - interval '40 minutes', now()),
('00000000-0000-0000-0006-000000008837','00000000-0000-0000-0006-000000000002','pr.ready_for_review','00000000-0000-0000-0000-000000000140','00000000-0000-0000-0000-000000000002',NULL,NULL,'idem-nd-8837','{"ticket":"DCC-140"}'::jsonb,'delivered',1,200,NULL, now() - interval '3 hours', now() - interval '3 hours', now()),
('00000000-0000-0000-0006-000000008836','00000000-0000-0000-0006-000000000002','pr.changes_requested','00000000-0000-0000-0000-000000000139','00000000-0000-0000-0000-000000000003',NULL,NULL,'idem-nd-8836','{"ticket":"DCC-139"}'::jsonb,'delivered',1,200,NULL, now() - interval '1 hour', now() - interval '1 hour', now())
ON CONFLICT (id) DO NOTHING;
